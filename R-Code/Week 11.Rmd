---
title: "Week-11-Principal Component Analysis in R"
...
```
#Calling STR function to look at the PCA object
...
# Plotting the PCA data with lables
```{r echo=TRUE, message=FALSE, warning=FALSE}
...
#Adding new samples to the PCA Data
```{r echo=TRUE, message=FALSE, warning=FALSE}
...
#Projecting New Sample Data Into OLD PCA Data
```{r echo=TRUE, message=FALSE, warning=FALSE}
